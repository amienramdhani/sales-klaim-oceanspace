...
<head>
    <meta charset="UTF-8">
    <title>Rekapitulasi Klaim Transportasi & Entertain - PT Media Selular Indonesia</title>
    <style>
        @page {
...
<body>
    ...
    <div class="report-title">REKAPITULASI PENGAJUAN KLAIM TRANSPORTASI & ENTERTAIN</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="text-align: left;">KEPERLUAN & LOKASI</th>
            ...
            @forelse($claims as $idx => $claim)
                ...
                <tr class="{{ $idx % 2 === 1 ? 'even' : '' }}">
                    ...
                    <td class="text-center font-bold">
                        {{ $claim->claim_type_string ?: ($claim->claim_type ?: 'Transport/Entertain') }}
                    </td>
                    <td class="text-left">
                        <div>{{ $claim->purpose_string ?: '-' }}</div>
                        @if($claim->note)
                            <div style="font-size: 6.5px; color: #64748b;">Lokasi: {{ $claim->note }}</div>
                        @endif
                    </td>
            ...
            @empty
                <tr>
                    <td colspan="11" class="text-center" style="color: #94a3b8; padding: 15px;">
                        Tidak ada data klaim transportasi & entertain untuk filter ini.
                    </td>
                </tr>
            @endforelse
